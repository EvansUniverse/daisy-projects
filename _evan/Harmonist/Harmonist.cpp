 ...
 * =  _   _                                  _     _    =
 * = | | | |                                (_)   | |   =
 * = | |_| | __ _ _ __ _ __ ___   ___  _ __  _ ___| |_  =
 * = |  _  |/ _` | '__| '_ ` _ \ / _ \| '_ \| / __| __| =
 * = | | | | (_| | |  | | | | | | (_) | | | | \__ \ |_  =
 * = \_| |_/\__,_|_|  |_| |_| |_|\___/|_| |_|_|___/\__| =
 * =                                                    =
 * ======================================================                                                                       
 * 
 * Harmonist is an intelligent chord progression generation
 * eurorack module designed for the Electrosmith Daisy Patch platform.
 */
